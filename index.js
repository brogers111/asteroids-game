...
const intervalId = window.setInterval(() => {
  ...
  switch (index) {
    case 0: //asteroid coming from left side of screen
      x = 0 - radius;
      y = Math.random() * canvas.height;
      (vx = 1), (vy = 0);
      break;
    case 1: //asteroid coming from bottom side of screen
      x = Math.random() * canvas.width;
      y = canvas.height + radius;
      (vx = 0), (vy = -1);
      break;
    case 2: //asteroid coming from right side of screen
      x = canvas.width + radius;
      y = Math.random() * canvas.height;
      (vx = -1), (vy = 0);
      break;
    case 3: //asteroid coming from top side of screen
      x = Math.random() * canvas.width;
      y = 0 - radius;
      (vx = 0), (vy = 1);
      break;
